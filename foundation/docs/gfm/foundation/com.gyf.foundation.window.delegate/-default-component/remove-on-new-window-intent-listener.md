//[foundation](../../../index.md)/[com.gyf.foundation.window.delegate](../index.md)/[DefaultComponent](index.md)/[removeOnNewWindowIntentListener](remove-on-new-window-intent-listener.md)

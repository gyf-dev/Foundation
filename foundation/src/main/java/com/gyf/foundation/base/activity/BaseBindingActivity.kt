...
/**
 * 这是一个基础绑定活动类，扩展了[BaseActivity]并使用了[ViewBinding]。
 * This is a base binding activity class that extends [BaseActivity] and uses [ViewBinding].
 *
 ...
 * @Date    2024/7/1 13:57
 */
open class BaseBindingActivity<VB : ViewBinding> : BaseActivity() {

...
/**
 * @Author Ifan.Ge
 * @Date 2024/9/29 10:46
 */
public class AppCompatNativeActivity extends FragmentNativeActivity implements AppCompatCallback,
    ...
    /**
     * Default constructor for AppCompatNativeActivity. All Activities must have a default constructor
     * for API 27 and lower devices or when using the default
     * {@link android.app.AppComponentFactory}.
     */
    public AppCompatNativeActivity() {
        super();
        initDelegate();
    }
     ...
     * {@link android.app.AppComponentFactory}.
     *
     * @see #AppCompatNativeActivity()
     */
    @ContentView
    public AppCompatNativeActivity(@LayoutRes int contentLayoutId) {

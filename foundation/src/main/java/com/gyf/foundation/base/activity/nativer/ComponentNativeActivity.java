 ...
 */
public class ComponentNativeActivity extends NativeActivity implements
        ContextAware,
        LifecycleOwner,
        ViewModelStoreOwner,
    ...
    private final ActivityResultRegistry mActivityResultRegistry = new ActivityResultRegistry() {
        ...
        public <I, O> void onLaunch(
            ...
            ComponentNativeActivity activity = ComponentNativeActivity.this;
    ...
    /**
     * Default constructor for  All Activities must have a default constructor
     * for API 27 and lower devices or when using the default
     * {@link android.app.AppComponentFactory}.
     */
    public ComponentNativeActivity() {
     ...
     * {@link android.app.AppComponentFactory}.
     *
     * @see #ComponentNativeActivity()
     */
    @ContentView
    public ComponentNativeActivity(@LayoutRes int contentLayoutId) {
        this();
     ...
     * <code>final</code> in a future version of  If you do override
     ...
     * <p>
     * Overriding this method is no longer supported and this method will be made
     * <code>final</code> in a future version of
     *
     ...
     *
     * @return The {@link OnBackPressedDispatcher} associated with this
     */
    @NonNull
    @Override
        ...
        if (mOnBackPressedDispatcher == null) {
            mOnBackPressedDispatcher = new OnBackPressedDispatcher(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ComponentNativeActivity.super.onBackPressed();
                        ...
                        if (Build.VERSION.SDK_INT >= 33) {
                            mOnBackPressedDispatcher.setOnBackInvokedDispatcher(
                                    Api33Impl.getOnBackInvokedDispatcher(
                                            (ComponentNativeActivity) lifecycleOwner
                                    )
                            );
                        }
                    }
     ...
     * {@link ActivityResultContracts}, provides hooks for
     * testing, and allow receiving results in separate, testable classes independent from your
     * activity. Use
     * {@link #registerForActivityResult(ActivityResultContract, ActivityResultCallback)}
     * passing in a {@link ActivityResultContracts.StartActivityForResult} object for the {@link ActivityResultContract}.
     */
    @Override
    @Deprecated
     ...
     * activity. Use
     * {@link #registerForActivityResult(ActivityResultContract, ActivityResultCallback)}
     * passing in a {@link ActivityResultContracts.StartIntentSenderForResult} object for the
     ...
     * in a {@link ActivityResultContracts.RequestMultiplePermissions} object for the {@link ActivityResultContract} and
    ...
    public void reportFullyDrawn() {
        try {
            if (SDK_INT >= Build.VERSION_CODES.Q) {
                if (Trace.isEnabled()) {
                    Trace.beginSection("reportFullyDrawn() for ComponentNativeActivity");
                }
            }

            if (SDK_INT > 19) {
                super.reportFullyDrawn();
            } else if (SDK_INT == 19 && ContextCompat.checkSelfPermission(this,
    ...
    static class ReportFullyDrawnExecutorApi1 implements ReportFullyDrawnExecutor {
         ...
         * {@link ComponentNativeActivity#reportFullyDrawn()}.
         *
